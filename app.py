...
try:
    ...
    if not df_raw.empty:
        ...
        last_month_date = first_day_of_this_month - pd.Timedelta(days=1)
        ...
        fig_area.add_trace(go.Scatter(
            ...
            fillcolor='rgba(0, 123, 255, 0.15)', # 透明感のある青
